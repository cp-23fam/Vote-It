  ...
  <div class="new-vote">
    <header class="page-header">
      <div>
        ...
        <p class="page-sub">Configure and launch a vote-it vote</p>
      </div>
    </header>
    ...
    <form v-else class="form-card" @submit.prevent="handleSubmit">
      ...
      <div class="field">
        ...
        <textarea
          ...
          placeholder="Additional context or details for vote-it members..."
          :disabled="loading"
          rows="3"
          maxlength="1000"
        />
      ...
      <div class="field">
        ...
        <div
          v-if="form.duration > 0 && !durationPresets.find((p) => p.value === form.duration)"
      ...
      <div class="field field-inline">
        ...
        <span class="field-hint"
          >Members' choices will not be linked to their identity in results</span
        >
      </div>
...
const isValid = computed(
  () =>
    form.value.title.trim().length > 0 && form.value.options.filter((o) => o.trim()).length >= 2,
)
